...
- Login page
- Progress folder and tangible images for reference
...
- Start integrating backend
    - ~~It does get the email, does not get the uid. I have no clue if this is correct since it does post even though the credentials are incorrect.~~
    - Email and UID gets posted correctly now
